...
import { Car, Users, User, Truck, Settings, FileText, MessageSquare, BookOpen } from 'lucide-react';
...
export function AdminDashboard({ token }: AdminDashboardProps) {
  ...
  const quickActions = [
    ...
    { icon: BookOpen, label: 'Catatan Perjalanan', color: 'bg-purple-500', action: () => router.push('/admin/logbooks') },
